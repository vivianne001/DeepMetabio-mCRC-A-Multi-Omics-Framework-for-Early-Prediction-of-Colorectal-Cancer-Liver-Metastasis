...
rm(list = ls())
#########################################################################
## GSE71222 dataset preprocessing
## set groups
...
# set working path to "...\raw data\Model Traning\GSE71222"
# upload gene expression matrix
# upload from the download file "series_matrix.txt"
eSet=getGEO(filename = "GSE71222_series_matrix.txt.gz",getGPL = F) # read in GEO Format
...
rownames(exp)[1:10]
## save preprocessed data from GSE71222 as rdata
