...
rm(list = ls())
#########################################################################
## GSE18105 dataset preprocessing
## set groups
...
# set working path to "...\raw data\Model Traning\GSE18105"
# upload gene expression matrix
# upload from the download file "series_matrix.txt"

eSet=getGEO(filename = "GSE18105_series_matrix.txt.gz",getGPL = F) # read in GEO data format
...
## filter out the unwanted samples
table(ph$`tissue:ch1`)
