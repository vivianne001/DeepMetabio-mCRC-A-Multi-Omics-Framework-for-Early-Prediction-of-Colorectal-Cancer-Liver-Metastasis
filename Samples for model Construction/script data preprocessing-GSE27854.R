...
rm(list = ls())
#########################################################################
## GSE27854 dataset preprocessing
## set groups
...
# set working path to "...\raw data\Model Evaluation\GSE27854"
# upload gene expression matrix
# upload from the download file "series_matrix.txt"
eSet=getGEO(filename = "GSE27854_series_matrix.txt.gz",getGPL = F) 
...
## save preprocessed data from GSE27854 as rdata
